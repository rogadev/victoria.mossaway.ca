...
export const roofMossTreatment = {
  ...
  keywords: 'roof moss treatment, moss treatment for roof, roof moss treatment victoria bc',
};
...
export const windowCleaning = {
  ...
  keywords: 'window cleaning, window cleaning services, professional window cleaning, window cleaning victoria bc',
};
...
export const gutterCleaning = {
  ...
  keywords: 'gutter cleaning, gutter cleaning services, expert gutter cleaning, gutter cleaning victoria bc',
};
...
export const faq = {
  ...
  keywords: 'mossaway faq, mossaway blog, mossaway news, mossaway updates, mossaway victoria bc',
};
...
export const contact = {
  ...
  keywords: 'contact mossaway, mossaway contact, mossaway victoria bc',
};
